...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        gamma = 1
        for r in rewards:
            list_of_discounted_rewards.append(gamma * r)
            gamma *= self.gamma

        list_of_discounted_returns = []
        discounted_returns = 0
        for dr in list_of_discounted_rewards[::-1]:
            discounted_returns += dr
            list_of_discounted_returns.insert(0, discounted_returns)
